...
export async function loginUser(email: string, password: string) {
  try {
    ...
    const response = await fetch("https://34.39.142.249/api/1.0/users/login", {
      method: "POST",
      headers: {
...
export async function registerUser(payload: RegisterUserPayload) {
  try {
    const response = await fetch(
      "https://34.39.142.249/api/1.0/users/register",
      {
        method: "POST",
        headers: {
...
export async function fetchRole() {
  try {
    ...
    const response = await fetch(
      `https://34.39.142.249/api/1.0/users/${userId}`
    );
    const data = await response.json();
...
export async function getAllAuctions() {
  try {
    const response = await fetch("https://34.39.142.249/api/1.0/auctions", {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
      },
...
export async function createAuction(payload: AuctionCard) {
  try {
    ...
    const response = await fetch(
      `https://34.39.142.249/api/1.0/auctions/${userId}`,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
...
export async function getAuctionsByAuctioneer() {
  try {
    ...
    const response = await fetch(
      `https://34.39.142.249/api/1.0/auctions/auctioneer/${userId}`,
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
...
export async function getAuctionById(id: string) {
  try {
    const response = await fetch(
      `https://34.39.142.249/api/1.0/auctions/specific/${id}`,
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
...
export async function updateAuction(payload: AuctionCard) {
  try {
    ...
    const response = await fetch(
      `https://34.39.142.249/api/1.0/auctions/${auctionId}`,
      {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
...
export async function createLot(payload: LotCard) {
  try {
    ...
    const response = await fetch(
      `https://34.39.142.249/api/1.0/lots/${auctionId}`,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
...
export async function getLotById(lotId: string) {
  ...
  try {
    const response = await fetch(
      `https://34.39.142.249/api/1.0/lots/specific/${lotId}`,
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
...
export async function updateLot(payload: LotCard) {
  try {
    ...
    const response = await fetch(
      `https://34.39.142.249/api/1.0/lots/${lotId}/edit`,
      {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
...
export async function getAllStorageLots() {
  ...
  try {
    const response = await fetch(
      `https://34.39.142.249/api/1.0/lots/${auctioneer_id}`,
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
...
export async function makeBid(lotId: string, bid: number) {
  try {
    ...
    const response = await fetch(
      `https://34.39.142.249/api/1.0/lots/bid/${lotId}`,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
...
export async function makeAutoBid(
  ...
  try {
    ...
    const response = await fetch(
      `https://34.39.142.249/api/1.0/lots/auto-bid/${lotId}/${buyerId}`,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
